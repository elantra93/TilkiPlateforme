...
<body class="login-page-admin d-flex align-items-center min-vh-100">
<div class="container">
            ...
            <div class="card login-card border-0">
                <div class="card-body p-4 p-md-5">
                    <div class="text-center mb-4">
                        <img src="/logobleu.svg" alt="TILKI" height="48" style="width:auto" class="mb-3">
                        <h1 class="h5 fw-bold text-body mb-1">Administration</h1>
                        <p class="text-muted small mb-0">Accès réservé au personnel TILKI</p>
                    </div>
